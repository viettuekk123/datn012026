...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'hybrid', enum: ['onsite', 'remote', 'hybrid'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsIn)(['onsite', 'remote', 'hybrid']),
    __metadata("design:type", String)
], UpdateProfileDto.prototype, "workType", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Tôi là một developer với 3 năm kinh nghiệm...' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
